...
async function generateContentWithFallback(
  ...
  primaryModel: string,
  generateParams: any,
  fallbackModels: string[] = ["gemini-2.5-flash", "gemini-2.5-flash-lite", "gemini-3.7-flash"]
...
ALL information, assistance, feedback, explanations, and responses MUST be provided in the Tigrinya language (ትግርኛ) using standard Ge'ez/Tigrinya Fidel script. Every single answer, advice, analysis, error feedback, and help text generated by you MUST be written in fluent, grammatically correct, and elegant Tigrinya (ትግርኛ).`;
