...
const ONBOARDING_STEPS: OnboardingStep[] = [
  {
    ...
    descEn: "Experience the premier Horn of Africa artificial intelligence platform, fusing ancient Axumite & Ge'ez cultural legacy with modern neural intelligence for Tigrinya language communities.",
    descTi: "እዚ ፕላትፎርምዚ ጥንታዊ ታሪክን ቅርጽን ኣክሱምን ግዕዝን ምስ ዘመናዊ ኣርቲፊሻል ኢንተለጀንስ ኣወሃሂዱ ንኹሎም ተዛረብቲ ትግርኛ ዝሰርሕ ናይ መጀመሪያ ኣክሱማይት AI እዩ።",
    narrationTi: "እንቋዕ ናብ ኣክሱማይት ኤ ኣይ ብደሓን መጻእኩም! እዚ ፕላትፎርምዚ ጥንታዊ ታሪክን ውርሻን ኣክሱምን ግዕዝን ምስ ዘመናዊ ቴክኖሎጂ ኣወሃሂዱ ዝሰርሕ ፍሉይ ናይ ቋንቋ ትግርኛ ኢንተለጀንስ እዩ።",
  ...
  },
  {
    ...
    descEn: "Speak naturally in Tigrinya. Speech synthesis converts AI responses into fluent Tigrinya audio.",
    descTi: "ብትግርኛ ብድምጽኹም ተዛረቡ፤ AI ድማ ብልክዕ ትግርኛ መልሲ ይህበኩም። መልሲ ብድምጺ ክትሰምዕዎን ርእይቶ ክትህቡሉን ትኽእሉ።",
    narrationTi: "ኣብ Obelisk Chat ብትግርኛ ብድምጽኹም ክትዛረቡ ትኽእሉ ኢኹም። Speech-to-text ብትክክል ይቕበሎ፣ AI ድማ ብትግርኛ ድምጺ ይምልሰልኩም።",
